...
import { Icon, Button, TextField, EntityCard, EmptyState } from '../ds'
    ...
    <div className="content">
      <div className="row" style={{ justifyContent: 'space-between' }}>
        <h1 className="row" style={{ margin: 0, gap: '0.5rem' }}>
          <Icon name="shield" size={24} /> Characters
        </h1>
      ...
      {characters.length === 0 ? (
        <EmptyState
          ...
          hint="Add the party with “New character”."
          action={<Button variant="primary" icon="plus" onClick={() => void create()}>New character</Button>}
      ...
      {editing && (
              ...
              <Button
                ...
                onClick={() =>
                  confirm({
                    ...
                    message: `Delete "${editing.name || 'this character'}"? This cannot be undone.`,
                    confirmLabel: 'Delete',
                    onConfirm: () => {
        ...
        >
          <TextField
            label="Name"
            value={editing.name}
            onChange={(e) => void updateCharacter(editing.id, { name: e.target.value })}
          />
          <TextField
            label="Player name"
